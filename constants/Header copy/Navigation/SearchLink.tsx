...
export default function SearchLink(props: SearchLinkProps) {
    ...
    return (
        <li className={"mb-3"}>
            <div className={"relative hover:after:opacity-100 after:opacity-0 after:h-[4px] after:bg-ecwadarkblue inline-block after:absolute after:left-0 after:right-0 after:bottom-[-5px] cursor-pointer"} onClick={() => {
                props.goToSearch(
