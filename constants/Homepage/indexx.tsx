            ...
            <div className="max-container">
                <div className="flex lg:flex-row flex-col-reverse justify-center items-center justify-between ">
                    ...
                    <Link href={'https://www.youtube.com/embed/vsypFJ5mNw0'}> 
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="text-center flex items-center justify-center mt-16 mb-10 lg:mb-0 text-white text-[25px] lg:mt-0 bg-ecwaorange h-36 w-36 rounded-full"  width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
