            ...
            <div className="max-container">
                <div className="flex lg:flex-row flex-col-reverse justify-center items-center justify-between ">
                    <div className="w-full lg:w-5/6">
                        ...
                        <p className="text-white">Want to serve God with us? <a className="underline text-ecwaorange mt-6">Connect with the Community. Code:1234</a></p>
                    </div>
                    <Link href={'https://us06web.zoom.us/j/4238512507?pwd=MdRJV7j65FZA8af00MvVL6GMD7WahO.1'}>                        
                ...
                <div className="hidden lg:grid sm:grid-cols-3 grid-cols-1 z-20 lg:grid-cols-3 items-center justify-center max-container my-20 lg:my-0 lg:absolute left-0 right-0 gap-6 mx-auto w-full -bottom-48 ">
                    ...
                    <ArticleCard date={undefined} link={"https://us06web.zoom.us/j/4238512507?pwd=MdRJV7j65FZA8af00MvVL6GMD7WahO.1"} linkLabel={"Join Live"} title={"Sunday services"} subtitle="10am - 12pm" content={"Join our sunday service"}  />
                    <ArticleCard link={"https://us06web.zoom.us/j/4238512507?pwd=MdRJV7j65FZA8af00MvVL6GMD7WahO.1"} linkLabel={"Join Live"} date={undefined} title={"Wednesday Prayer "} content={"Join our prayer session"} subtitle="7pm - 8pm"  />
                    <ArticleCard link={"https://us06web.zoom.us/j/4238512507?pwd=MdRJV7j65FZA8af00MvVL6GMD7WahO.1"} linkLabel={"Join Live"} date={undefined} title={"Friday Vigil"} content={"Join our last friday vigil"} subtitle="10pm - 12am"  />
                </div>
