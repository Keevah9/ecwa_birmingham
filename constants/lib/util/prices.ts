...
export function convertToMedusaJSValue(inputValue: number) {
    // Divide the value by 100 to convert it to the decimal representation
    const decimalValue = inputValue / 100

    return decimalValue.toFixed(2) // Always show 2 decimal places
}
