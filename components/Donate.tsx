...
export default function Donate() {
    return (
        <section  className=" relative lg:flex-row flex-col-reverse ">
            ...
            <div className="  w-full gap-8 max-container  left-0 flex flex-col items-center justify-center text-center lg:text-left ">
                <div> 
                ...
                <div className="hidde mt-8 lg:block"> <Button type={"button"} title={"Contact us"} link="/contact-us" variant="btn" /></div>
            </div>
