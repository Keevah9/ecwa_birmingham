        ...
        <div className="xs:w-full flex xs:bg-no-repeat xs:bg-cover xs:bg-left relative  text flex items-cente relative lg:flex-row flex-col-reverse min-h-[690px]">
            ...
            <div className=" absolut lg:w-1/2 bg-ecwadarkblue right-10  max-containe py-20 lg:py-0 left-0 flex items-centerr justify-center  ">
                <div className=" w-fit shadow-m  text-center flex flex-col justify-center items-center  rounded-[10px] ">
                    ...
                    <p className=" mb-10 mt-6 text-white max-w-md px-4 lg:px-0 lg:max-w-">Join us for our church events! This special event is an opportunity for our congregation to come together and serve our local community. We'll have various activities, including a food drive and fun games for kids. There will also be inspiring worship sessions and prayer sessions to enjoy. Whether you're a long-time member or new to ECWA Birmingham, we invite you to be part of this day of service, fellowship, and celebration. Don't miss out on this chance to make a positive impact and connect with others in a meaningful way!</p>
